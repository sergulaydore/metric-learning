...
public abstract class AbstractStringMetric implements InterfaceStringMetric {
     ...
     */
    public final double[] batchCompareSet(final String[] set, final String comparator) {
        final double[] results = new double[set.length];
     ...
     */
    public final double[] batchCompareSets(final String[] firstSet, final String[] secondSet) {
     ...
     */
    public abstract double getSimilarityTimingEstimated(final String string1, final String string2);
     ...
     */
    public abstract double getSimilarity(String string1, String string2);
     ...
     */
    public abstract double getUnNormalisedSimilarity(String string1, String string2);
}

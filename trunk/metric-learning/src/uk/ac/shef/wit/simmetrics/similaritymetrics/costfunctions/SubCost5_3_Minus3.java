...
public final class SubCost5_3_Minus3 extends AbstractSubstitutionCost implements Serializable {
     ...
     *
     * @param source         - the string1 to evaluate the cost
     * @param string1Index - the index within the string1 to test
     * @param target         - the string2 to evaluate the cost
    ...
    public final double getSubstitutionCost(final int string1Index, final int string2Index) {
        ...
        if (source.charAt(string1Index) == target.charAt(string2Index)) {
            ...
            final Character si = Character.toLowerCase(source.charAt(string1Index));
            final Character ti = Character.toLowerCase(target.charAt(string2Index));
